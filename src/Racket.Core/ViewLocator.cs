...
using Racket.Core.Views.Players;
using Racket.Core.Views.Menus;
using ReactiveUI;
...
public class ViewLocator : IDataTemplate
{
    ...
    public static readonly Dictionary<Type, Func<Control>> _viewFactories = new()
    {
        ...
        [typeof(GenreViewModel)] = () => new GenreView(),
        ...
        [typeof(LoadMoreListViewModel<GenreViewModel>)] = () => new LoadMoreListView(),
