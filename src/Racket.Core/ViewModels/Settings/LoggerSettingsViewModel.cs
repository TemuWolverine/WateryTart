...
public partial class LoggerSettingsViewModel : ViewModelBase<LoggerSettingsViewModel>, IHaveSettings
{
    ...
    public string Description => "Logging settings for debugging Racket";
    ...
    {
        var appDataPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Racket");
        return Path.Combine(appDataPath, "Racket.log");
    }
