...
public partial class LoggerSettingsViewModel : ViewModelBase<LoggerSettingsViewModel>, IHaveSettings
{
    ...
    public string Description => "Logging settings for debugging SillyMIDI";
    ...
    {
        var appDataPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "SillyMIDI");
        return Path.Combine(appDataPath, "SillyMIDI.log");
    }
